...
EPOCHS_PER_TRIAL = 200  # Short training for quick evaluation
...
def objective(trial):
    # Train/val split with fixed random state
    ...
    # Optimizer settings (Optuna suggests learning rate)
...
if __name__ == "__main__":
    ...
    print("\nParameters saved to 'best_params.txt'.")